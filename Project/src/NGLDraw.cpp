...
void NGLDraw::handleEvent(SDL_Event* _event)
{
    std::cout<<"handle event\n";



    if(_event->type == SDL_MOUSEMOTION){main_cam->eventHandler(_event);}


}

void NGLDraw::updateEvent()
{
